...
import type {Category, CategoryWithItems, ChecklistItem} from "@/lib/types"
    ...
    return (
        <div className="min-h-screen bg-amber-50">
                ...
                <div className="container mx-auto px-4 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-amber-100 text-sm mt-1 max-w-2xl">
                            Calculated based on the frequency and intensity of participation activities, weighted
                            according to their
                            significance
                        </p>
                    </div>
            ...
            <div className="container mx-auto px-4 py-4">
                <div className="inline-block bg-amber-200 text-amber-900 px-3 py-1 text-sm font-semibold rounded">Page
                    1
                </div>
            </div>
