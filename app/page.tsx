                                    ...
                                    <div className="border-2 border-dashed border-input rounded-lg p-4">
                                        {imagePreview ? (
                                            ...
                                            >
                                                ...
                                                <span
                                                    className="text-xs text-muted-foreground mt-1">Max size: 5MB</span>
                                                <input
                                                    id="project-image"
                                                    type="file"
                                                    accept="image/*"
                ...
                <Card className="bg-card border-border mb-8">
                    ...
                    <CardContent className="space-y-4">
                        <p className="text-muted-foreground leading-relaxed">
                            Measuring community participation is essential to assessing the level of engagement and
                            influence of
                            stakeholders in development projects. Participation is multidimensional, encompassing
                            attendance,
                            consultation, involvement, collaboration, and empowerment. Various researchers have
                            highlighted that
                            participation is not merely about presence, but about the extent of contribution and
                            decision-making power
                            (Arnstein, 1969; Pretty, 1995; IAP2, 2018). In this study, participation is quantified using
                            a
                            Participation Index (PI), calculated based on frequency and intensity of participation
                            activities,
                            weighted according to their significance. Following the frameworks of Arnstein (1969),
                            Pretty (1995), and
                            IAP2 (2018), community participation activities were classified into five levels based on
                            the depth of
                            engagement:
                        </p>
                        ...
                        {projects.map((project) => {
                            ...
                            return (
                                <div key={project.id} onClick={() => router.push(`/project/${project.id}`)}
                                    ...
                                    <Card
                                        className="bg-card border-border hover:border-primary/50 transition-all group h-full overflow-hidden">
                                        {project.image_url && (
                                        ...
                                        <CardHeader className="pb-3">
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1 min-w-0">
                                                    <CardTitle
                                                        className="text-foreground text-base font-medium truncate group-hover:text-primary transition-colors">
                                                        {project.name}
                                                    </CardTitle>
                                                    <CardDescription
                                                ...
                                                <ArrowRight
                                                    className="h-4 w-4 text-muted-foreground group-hover:text-primary group-hover:translate-x-1 transition-all shrink-0 ml-2"/>
                                            </div>
                                        </CardHeader>
                                        <CardContent className="pt-0">
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex items-center justify-between text-sm">
                                                    ...
                                                    <span
                                                        className={`font-medium ${isComplete ? "text-success" : "text-foreground"}`}>
